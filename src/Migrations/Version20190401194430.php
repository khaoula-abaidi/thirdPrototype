 ...
 */
final class Version20190401194430 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contributor (id INT AUTO_INCREMENT NOT NULL, decision_id INT DEFAULT NULL, civility VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, firstname VARCHAR(255) DEFAULT NULL, complement_name VARCHAR(255) DEFAULT NULL, login VARCHAR(255) NOT NULL, pwd VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, photo VARCHAR(255) DEFAULT NULL, INDEX IDX_DA6F9793BDEE7539 (decision_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE structure (id INT AUTO_INCREMENT NOT NULL, affiliation_id INT DEFAULT NULL, sigle VARCHAR(255) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, pays VARCHAR(255) DEFAULT NULL, INDEX IDX_6F0137EACB94D64E (affiliation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
